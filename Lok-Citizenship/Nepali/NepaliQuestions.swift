...
enum NepaliQuestions {
    ...
    static let practice2: [UnifiedQuestion] = [
        ...
        UnifiedQuestion(correctAnswer: 2, variants: [
            ...
            .init(text: "संयुक्त राज्य अमेरिकाको आर्थिक प्रणाली के हो?", options: ["साम्यवाद", "साम्यवाद", "पूँजीवाद", "राजतन्त्र"])
        ]),
        UnifiedQuestion(correctAnswer: 3, variants: [
    ...
    static let practice4: [UnifiedQuestion] = [
        ...
        UnifiedQuestion(correctAnswer: 3, variants: [
            ...
            .init(text: "सर्वोच्च अदालतको न्यायाधीशको कार्यकाल कति हुन्छ?", options: ["४ वर्ष", "१२ वर्ष", "८ वर्ष", "जीवनभरि"])
        ]),
        UnifiedQuestion(correctAnswer: 0, variants: [
