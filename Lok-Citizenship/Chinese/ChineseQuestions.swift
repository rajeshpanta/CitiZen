...
enum ChineseQuestions {
    ...
    static let practice4: [UnifiedQuestion] = [
        ...
        UnifiedQuestion(id: "q_4_06", correctAnswer: 2, variants: [
            ...
            .init(text: "美国参战第二次世界大战的主要原因是什么？", options: ["支持英国和法国", "阻止共产主义蔓延", "珍珠港袭击", "抵御德国"]),
    ...
    static let practice5: [UnifiedQuestion] = [
        ...
        UnifiedQuestion(id: "q_5_12", correctAnswer: 1, variants: [
            ...
            .init(text: "2001年9月11日，美国发生了什么重大事件？", options: ["美国对伊拉克宣战", "恐怖分子袭击美国", "大萧条开始", "卡特里娜飓风袭击"]),
        ...
        UnifiedQuestion(id: "q_5_14", correctAnswer: 3, variants: [
